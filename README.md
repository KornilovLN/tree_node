...
```
## Первый вариант Программа tree_node.py создает сайт из исходной папки с содержимым
...
## Второй вариант программы folder2site.py

### в папку с проектом помещаем каталог исходных текстовых данных

#### после запуска программы появляется готовый каталог с сайтом

<br>программа в стадии доработки
